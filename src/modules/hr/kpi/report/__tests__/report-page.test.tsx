...
jest.mock('@/modules/hr/kpi/report/report-table', () => ({
  ReportTable: () => null,
}));

jest.mock('@/modules/hr/kpi/report/report-detail-modal', () => ({
  ReportDetailModal: () => null,
}));

jest.mock('@/modules/hr/kpi/report/report-submit-modal', () => ({
  ReportSubmitModal: () => null,
}));

jest.mock('@/modules/hr/kpi/report/report-review-dialog', () => ({
