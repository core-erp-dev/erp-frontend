...
export const UnitPerformanceConfigurationPage: React.FC = () => {
  ...
  return (
    <div className="flex w-full flex-col gap-6">
      ...
      <UnitPerformanceWeightMatrix matrix={tableMatrix} draft={draft} canEdit={isEditing && canManage} isLoading={tableLoading} error={tableError} onRetry={handleRetry} onDraftChange={handleDraftChange} />
      {addOpen && <UnitPerformanceAddModal isOpen onClose={() => setAddOpen(false)} onSubmit={handleAddUnit} orgUnits={availableUnits} configuredUnits={configuredUnits} onRemove={setDeleteTarget} isSubmitting={isMutating} />}
