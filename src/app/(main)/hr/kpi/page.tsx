...
import { KPI_LABELS, KPI_DESCRIPTIONS, KPI_ANY_PERMISSION, KPI_ROUTES } from '@/modules/hr/kpi/constants';
import { useOverviewData, averageProgress, targetReachedCount, countActiveIndicators } from '@/modules/hr/kpi/overview/use-overview-data';
import { OverviewSection, MetricBlock } from '@/modules/hr/kpi/overview/overview-section';
import { REPORT_STATUS_LABEL } from '@/modules/hr/kpi/report/report.types';
import type { KpiActivityResponse } from '@/modules/hr/kpi/activity/activity.types';
...
export default function KpiOverviewPage() {
  ...
  return <KpiOverviewContent />;
}

function KpiOverviewContent() {
  const {
